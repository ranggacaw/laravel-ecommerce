...
<div class="container-fluid p-0">
    <div id="shop-categories" class="header-stick footer-stick clearfix mt-5">
        <div class="entry-image mb-0" style="background: url({{asset('images/shop/category/15.jpg')}}) no-repeat center center / cover; height:450px;" data-center="background-position: 50% 0px;" data-top-bottom="background-position:50% 200px;"></div>
    </div>
</div>
@endsection
